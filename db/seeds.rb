...
lorem_bio = 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsam, labore nam? Perferendis hic, esse quia in corrupti doloremque laborum, omnis quae placeat facere aliquid amet excepturi.'
...
user4 = User.create!(name: 'Oliver Queen', photo: image4,  bio: lorem_bio +'- Oliver Queen', posts_counter: 0)
user5 = User.create!(name: 'Barry alen', photo: image5,  bio: lorem_bio +'- Barry alen', posts_counter: 0)

lorem_one = 'Donec dapibus consequat tellus a pulvinar. Fusce auctor rhoncus orci a semper. Sed interdum accumsan ullamcorper.'
lorem_two = 'Mauris hendrerit odio eu quam dapibus, sit amet malesuada quam pulvinar. Ut quis venenatis ex, eu tristique orci.'
lorem_third = 'Fusce auctor rhoncus orci a semper dapibus, sit amet malesuada quam pulvinar. Ut quis venenatis ex, eu tristique orci.'

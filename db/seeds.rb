...
user1 = User.create!(name: 'John Doe', photo: image1, bio: "#{lorem_bio}- John Doe", postsCounter: 0)
user2 = User.create!(name: 'Michal Smith ', photo: image2, bio: "#{lorem_bio}- Michal Smith", postsCounter: 0)
user3 = User.create!(name: 'Julia Lisa', photo: image3, bio: "#{lorem_bio}- Danny Dril", postsCounter: 0)
user4 = User.create!(name: 'Gomez lucky', photo: image4, bio: "#{lorem_bio}- Gomez lucky", postsCounter: 0)
user5 = User.create!(name: 'Barry Alen', photo: image5, bio: "#{lorem_bio}- Barry alen", postsCounter: 0)
...
post1 = user1.posts.create!(title: 'Animal', text: lorem_one, commentsCounter: 0, likesCounter: 0)
post2 = user1.posts.create!(title: 'Population', text: lorem_two, commentsCounter: 0, likesCounter: 0)
...
post13 = user4.posts.create!(title: 'Arts', text: lorem_two, commentsCounter: 0, likesCounter: 0)
post14 = user4.posts.create!(title: 'Achool', text: lorem_third, commentsCounter: 0, likesCounter: 0)
post15 = user4.posts.create!(title: 'Business', text: lorem_four, commentsCounter: 0, likesCounter: 0)

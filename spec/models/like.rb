...
RSpec.describe Like, type: :model do
  before(:each) do
    @user = User.new(id: 1, name: 'Ben', bio: 'I am a content creator', photo: '', postsCounter: 0)
    @post = Post.new(title: 'Post1', text: 'Text...', commentsCounter: 0, likesCounter: 1, author_id: @user.id)
